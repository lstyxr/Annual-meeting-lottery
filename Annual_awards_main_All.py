    ...
    for i in range(n):
        ...
        for j in range(m):
            if i == n -1:
                temp = name_list
                break
            temp.append(name_list.pop())
        total.append(temp)
    for n, item in enumerate(total):
        item = pd.DataFrame(item)
        item.to_excel("全员大抽奖第{}轮.xlsx".format(n))
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption("全员大抽奖...")
    ...
    while True:
        ...
        if not pause_flag:
            ...
            font = pygame.font.Font("simhei.ttf", 80)
            text_obj = font.render(text_context, True, (255, 255, 255))
        ...
        # 顶部提示
        text_obj_2 = font.render('全员大抽奖', True, (255, 255, 255))
