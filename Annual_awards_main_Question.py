...
def getData(n):
    ...
    m = math.ceil(len(name_list) / n)
    total = []
    question = []

    # 随机分成 n 组
    for i in range(0, len(name_list), m):
        total.append(name_list[i : i + m])
    ...
    for n, item in enumerate(total):
        ...
        item.to_excel("答题大抽奖第{}轮.xlsx".format(n))
    return name_list, question
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption("答题大抽奖...")
    ...
    while True:
        ...
        if not pause_flag:
            ...
            text_obj_pos.center = (width/2, 280)
        ...
        if num > 0 and num % 2 == 0 and num <= n*2 and pause_flag and not is_done:
            ...
            font = pygame.font.Font("simhei.ttf", 90)
        ...
        # 顶部提示
        text_obj_2 = font.render('答题大抽奖', True, (255, 255, 255))
